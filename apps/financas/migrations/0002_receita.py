    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cadastrada_em', models.DateTimeField(auto_now=True, verbose_name='Cadastrada em')),
                ('atualizada_em', models.DateTimeField(auto_now_add=True, verbose_name='Atualizada em')),
